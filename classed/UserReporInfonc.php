...
/**
	...
	{
		$result = $this->db->query("SELECT * FROM g_kaipan9 WHERE `g_lock` = 2 ORDER BY g_qishu DESC LIMIT 1  ", 1);
		if ($result)
		{
			switch ($this->cid)
			{
			...
			$oddsList = selectOddsnc($p, $g_id); //賠率
