...
class SumAmountxyft 
{
	...
	{
		$g_type=" and g_type='极速赛车' ";
		$sql = "SELECT `g_qishu`, `g_ball_1`, `g_ball_2`, `g_ball_3`, `g_ball_4`, `g_ball_5`, `g_ball_6`, `g_ball_7`, `g_ball_8`, `g_ball_9`, `g_ball_10`  FROM `g_history4` WHERE `g_qishu` = '{$this->Number}' AND g_ball_1 is not null LIMIT 1";
