...
class UserReportInfoxyft
{
	...
	private function UserInfo ($number)
	{
		...
		if ($result && Copyright)
		{
			...
			switch ($this->cid)
			{
				case 1: $typeString = Array(0=>'冠军',1=>'亚军',2=>'',3=>'') ; break;
				case 2: $typeString = Array(0=>'第三名',1=>'第四名',2=>'第五名',3=>'第六名'); break;
				case 3: $typeString = Array(0=>'第七名',1=>'第八名',2=>'第九名',3=>'第十名'); break;
			}
	...
	private function GroupCount ($RepList, $typeString, $number=null)
	{
		...
		for ($i=0; $i<count($RepList); $i++)
		{
			...
			if ($RepList[$i]['g_mingxi_1'] == '冠军' && Copyright){
				$arr['count_c'][1] += $RepList[$i]['g_jiner'];
				$arr['count_d'][0] ++;
			} else if ($RepList[$i]['g_mingxi_1'] == '亚军' && Copyright){
				$arr['count_c'][2] += $RepList[$i]['g_jiner'];
				$arr['count_d'][1] ++;
			} else if ($RepList[$i]['g_mingxi_1'] == '第三名' && Copyright){
				$arr['count_c'][3] += $RepList[$i]['g_jiner'];
				$arr['count_d'][2] ++;
			} else if ($RepList[$i]['g_mingxi_1'] == '第四名' && Copyright){
				$arr['count_c'][4] += $RepList[$i]['g_jiner'];
				$arr['count_d'][3] ++;
			} else if ($RepList[$i]['g_mingxi_1'] == '第五名' && Copyright){
			...
			if ($RepList[$i]['g_mingxi_1'] == $typeString[0] || $RepList[$i]['g_mingxi_1'] == $typeString[1] ||$RepList[$i]['g_mingxi_1'] == $typeString[2] || $RepList[$i]['g_mingxi_1'] == $typeString[3] && Matchs::isNumber($RepList[$i]['g_mingxi_2'])) {
				//1-20組總投注額
			...
			} else if ($RepList[$i]['g_mingxi_1'] == $typeString[0] || $RepList[$i]['g_mingxi_1'] == $typeString[1] ||$RepList[$i]['g_mingxi_1'] == $typeString[2] || $RepList[$i]['g_mingxi_1'] == $typeString[3] && ($RepList[$i]['g_mingxi_2'] =='單' || $RepList[$i]['g_mingxi_2'] == '雙')) {
				//單雙組總投注額
			...
			if ($RepList[$i]['g_mingxi_1'] == $typeString[0] || $RepList[$i]['g_mingxi_1'] == $typeString[1] ||$RepList[$i]['g_mingxi_1'] == $typeString[2] || $RepList[$i]['g_mingxi_1'] == $typeString[3] && Copyright) 
			{
			switch($this->cid){
			...
			if($RepList[$i]['g_mingxi_1'] == $typeString[0]){
				switch ($RepList[$i]['g_mingxi_2']) {
					...
					case '7' : $sArr['t'.(1+$tempnum).'_7'] += $RepList[$i]['g_jiner']; break;
					case '8' : $sArr['t'.(1+$tempnum).'_8'] += $RepList[$i]['g_jiner']; break;
					case '9' : $sArr['t'.(1+$tempnum).'_9'] += $RepList[$i]['g_jiner']; break;
					case '10' : $sArr['t'.(1+$tempnum).'_10'] += $RepList[$i]['g_jiner']; break;
					
					case '大' : $sArr['t'.(1+$tempnum).'_11'] += $RepList[$i]['g_jiner']; break;
					case '小' : $sArr['t'.(1+$tempnum).'_12'] += $RepList[$i]['g_jiner']; break;
					case '單' : $sArr['t'.(1+$tempnum).'_13'] += $RepList[$i]['g_jiner']; break;
					case '雙' : $sArr['t'.(1+$tempnum).'_14'] += $RepList[$i]['g_jiner']; break;
					
					case '龍' : $sArr['t'.(1+$tempnum).'_15'] += $RepList[$i]['g_jiner']; break;
					
					case '虎' : $sArr['t'.(1+$tempnum).'_16'] += $RepList[$i]['g_jiner']; break;
				}
				...
				switch ($RepList[$i]['g_mingxi_2']) {
					...
					case '7' : $sArr['t'.(2+$tempnum).'_7'] += $RepList[$i]['g_jiner']; break;
					case '8' : $sArr['t'.(2+$tempnum).'_8'] += $RepList[$i]['g_jiner']; break;
					case '9' : $sArr['t'.(2+$tempnum).'_9'] += $RepList[$i]['g_jiner']; break;
					case '10' : $sArr['t'.(2+$tempnum).'_10'] += $RepList[$i]['g_jiner']; break;
					
					case '大' : $sArr['t'.(2+$tempnum).'_11'] += $RepList[$i]['g_jiner']; break;
					case '小' : $sArr['t'.(2+$tempnum).'_12'] += $RepList[$i]['g_jiner']; break;
					case '單' : $sArr['t'.(2+$tempnum).'_13'] += $RepList[$i]['g_jiner']; break;
					case '雙' : $sArr['t'.(2+$tempnum).'_14'] += $RepList[$i]['g_jiner']; break;
					
					case '龍' : $sArr['t'.(2+$tempnum).'_15'] += $RepList[$i]['g_jiner']; break;
				
					case '虎' : $sArr['t'.(2+$tempnum).'_16'] += $RepList[$i]['g_jiner']; break;
				}
				}else if($RepList[$i]['g_mingxi_1'] == $typeString[2]){
				switch ($RepList[$i]['g_mingxi_2']) {
					case '1' : $sArr['t'.(3+$tempnum).'_1'] += $RepList[$i]['g_jiner']; break;
					case '2' : $sArr['t'.(3+$tempnum).'_2'] += $RepList[$i]['g_jiner']; break;
					case '3' : $sArr['t'.(3+$tempnum).'_3'] += $RepList[$i]['g_jiner']; break;
					case '4' : $sArr['t'.(3+$tempnum).'_4'] += $RepList[$i]['g_jiner']; break;
					case '5' : $sArr['t'.(3+$tempnum).'_5'] += $RepList[$i]['g_jiner']; break;
					case '6' : $sArr['t'.(3+$tempnum).'_6'] += $RepList[$i]['g_jiner']; break;
					case '7' : $sArr['t'.(3+$tempnum).'_7'] += $RepList[$i]['g_jiner']; break;
					case '8' : $sArr['t'.(3+$tempnum).'_8'] += $RepList[$i]['g_jiner']; break;
					case '9' : $sArr['t'.(3+$tempnum).'_9'] += $RepList[$i]['g_jiner']; break;
					case '10' : $sArr['t'.(3+$tempnum).'_10'] += $RepList[$i]['g_jiner']; break;
					
					case '大' : $sArr['t'.(3+$tempnum).'_11'] += $RepList[$i]['g_jiner']; break;
					case '小' : $sArr['t'.(3+$tempnum).'_12'] += $RepList[$i]['g_jiner']; break;
					case '單' : $sArr['t'.(3+$tempnum).'_13'] += $RepList[$i]['g_jiner']; break;
					case '雙' : $sArr['t'.(3+$tempnum).'_14'] += $RepList[$i]['g_jiner']; break;
					
					case '龍' : $sArr['t'.(3+$tempnum).'_15'] += $RepList[$i]['g_jiner']; break;
				
					case '虎' : $sArr['t'.(3+$tempnum).'_16'] += $RepList[$i]['g_jiner']; break;
				}
				}else if($RepList[$i]['g_mingxi_1'] == $typeString[3]){
				switch ($RepList[$i]['g_mingxi_2']) {
					case '1' : $sArr['t'.(4+$tempnum).'_1'] += $RepList[$i]['g_jiner']; break;
					case '2' : $sArr['t'.(4+$tempnum).'_2'] += $RepList[$i]['g_jiner']; break;
					case '3' : $sArr['t'.(4+$tempnum).'_3'] += $RepList[$i]['g_jiner']; break;
					case '4' : $sArr['t'.(4+$tempnum).'_4'] += $RepList[$i]['g_jiner']; break;
					case '5' : $sArr['t'.(4+$tempnum).'_5'] += $RepList[$i]['g_jiner']; break;
					case '6' : $sArr['t'.(4+$tempnum).'_6'] += $RepList[$i]['g_jiner']; break;
					case '7' : $sArr['t'.(4+$tempnum).'_7'] += $RepList[$i]['g_jiner']; break;
					case '8' : $sArr['t'.(4+$tempnum).'_8'] += $RepList[$i]['g_jiner']; break;
					case '9' : $sArr['t'.(4+$tempnum).'_9'] += $RepList[$i]['g_jiner']; break;
					case '10' : $sArr['t'.(4+$tempnum).'_10'] += $RepList[$i]['g_jiner']; break;
					
					case '大' : $sArr['t'.(4+$tempnum).'_11'] += $RepList[$i]['g_jiner']; break;
					case '小' : $sArr['t'.(4+$tempnum).'_12'] += $RepList[$i]['g_jiner']; break;
					case '單' : $sArr['t'.(4+$tempnum).'_13'] += $RepList[$i]['g_jiner']; break;
					case '雙' : $sArr['t'.(4+$tempnum).'_14'] += $RepList[$i]['g_jiner']; break;
					
					case '龍' : $sArr['t'.(4+$tempnum).'_15'] += $RepList[$i]['g_jiner']; break;
				
					case '虎' : $sArr['t'.(4+$tempnum).'_16'] += $RepList[$i]['g_jiner']; break;
				}
				}
			}
			if( $this->cid==1){
	...
	private function GetUserCrystals($UserList, $sArr, $arr, $typeString)
	{
		...
		for ($i=0; $i<count($UserList); $i++){
			...
			if ($UserList[$i]['g_mingxi_1'] == '冠军'){
				$arr['count_c'][1] = $arr['count_c'][1]-$n;
				//$arr['count_d'][0] ++;
			} else if ($UserList[$i]['g_mingxi_1'] == '亚军'){
				$arr['count_c'][2] = $arr['count_c'][2]-$n;
				//$arr['count_d'][1] ++;
			} else if ($UserList[$i]['g_mingxi_1'] == '第三名'){
				$arr['count_c'][3] = $arr['count_c'][3]-$n;
				//$arr['count_d'][2] ++;
			} else if ($UserList[$i]['g_mingxi_1'] == '第四名'){
				$arr['count_c'][4] = $arr['count_c'][4]-$n;
				//$arr['count_d'][3] ++;
			} else if ($UserList[$i]['g_mingxi_1'] == '第五名'){
			...
			if ($UserList[$i]['g_mingxi_1'] == $typeString[0] || $UserList[$i]['g_mingxi_1'] || $UserList[$i]['g_mingxi_1'] == $typeString[2] || $UserList[$i]['g_mingxi_1'] == $typeString[3] && Copyright) 
			{
			switch($this->cid){
				case 1:$tempnum=0;break;
				case 2:$tempnum=2;break;
			...
			if ($UserList[$i]['g_mingxi_1'] == $typeString[0]){
				switch ($UserList[$i]['g_mingxi_2']) {
					...
					case '8' :  
						...
						break;
					case '9' :  
						$arr['list']['t'.(1+$tempnum).'_9']=$arr['list']['t'.(1+$tempnum).'_9'] - $n;
						$arr['count'][0] =$arr['count'][0]- $n;
						break;
					case '10' :  
						$arr['list']['t'.(1+$tempnum).'_10']=$arr['list']['t'.(1+$tempnum).'_10'] - $n;
						$arr['count'][0] =$arr['count'][0]- $n;
						break;
					
					case '大' : $arr['list']['t'.(1+$tempnum).'_11']=$arr['list']['t'.(1+$tempnum).'_11'] - $n; break;
					case '小' : $arr['list']['t'.(1+$tempnum).'_12']=$arr['list']['t'.(1+$tempnum).'_12'] - $n; break;
					case '單' : $arr['list']['t'.(1+$tempnum).'_13']=$arr['list']['t'.(1+$tempnum).'_13'] - $n; break;
					case '雙' : $arr['list']['t'.(1+$tempnum).'_14']=$arr['list']['t'.(1+$tempnum).'_14'] - $n; break;
					
					case '龍' : $arr['list']['t'.(1+$tempnum).'_15']=$arr['list']['t'.(1+$tempnum).'_15'] - $n; break;
					
					case '虎' : $arr['list']['t'.(1+$tempnum).'_16']=$arr['list']['t'.(1+$tempnum).'_16'] - $n; break;
				}}
				...
				switch ($UserList[$i]['g_mingxi_2']) {
					...
					case '7' :  
						...
						break;
					case '8' :  
						$arr['list']['t'.(2+$tempnum).'_8']=$arr['list']['t'.(2+$tempnum).'_8'] - $n;
						$arr['count'][0] =$arr['count'][0]- $n;
						break;
					case '9' :  
						$arr['list']['t'.(2+$tempnum).'_9']=$arr['list']['t'.(2+$tempnum).'_9'] - $n;
						$arr['count'][0] =$arr['count'][0]- $n;
						break;
					case '10' :  
						$arr['list']['t'.(2+$tempnum).'_10']=$arr['list']['t'.(2+$tempnum).'_10'] - $n;
						$arr['count'][0] =$arr['count'][0]- $n;
						break;
					
					case '大' : $arr['list']['t'.(2+$tempnum).'_11']=$arr['list']['t'.(2+$tempnum).'_11'] - $n; break;
					case '小' : $arr['list']['t'.(2+$tempnum).'_12']=$arr['list']['t'.(2+$tempnum).'_12'] - $n; break;
					case '單' : $arr['list']['t'.(2+$tempnum).'_13']=$arr['list']['t'.(2+$tempnum).'_13'] - $n; break;
					case '雙' : $arr['list']['t'.(2+$tempnum).'_14']=$arr['list']['t'.(2+$tempnum).'_14'] - $n; break;
					
					case '龍' : $arr['list']['t'.(2+$tempnum).'_15']=$arr['list']['t'.(2+$tempnum).'_15'] - $n; break;
					
					case '虎' : $arr['list']['t'.(2+$tempnum).'_16']=$arr['list']['t'.(2+$tempnum).'_16'] - $n; break;
				...
				switch ($UserList[$i]['g_mingxi_2']) {
					...
					case '大' : $arr['list']['t'.(3+$tempnum).'_11']=$arr['list']['t'.(3+$tempnum).'_11'] - $n; break;
					case '小' : $arr['list']['t'.(3+$tempnum).'_12']=$arr['list']['t'.(3+$tempnum).'_12'] - $n; break;
					case '單' : $arr['list']['t'.(3+$tempnum).'_13']=$arr['list']['t'.(3+$tempnum).'_13'] - $n; break;
					case '雙' : $arr['list']['t'.(3+$tempnum).'_14']=$arr['list']['t'.(3+$tempnum).'_14'] - $n; break;
					
					case '龍' : $arr['list']['t'.(3+$tempnum).'_15']=$arr['list']['t'.(3+$tempnum).'_15'] - $n; break;
					
					case '虎' : $arr['list']['t'.(3+$tempnum).'_16']=$arr['list']['t'.(3+$tempnum).'_16'] - $n; break;
				}}else{
				switch ($UserList[$i]['g_mingxi_2']) {
					case '1' : 
					...
					case '大' : $arr['list']['t'.(4+$tempnum).'_11']=$arr['list']['t'.(4+$tempnum).'_11'] - $n; break;
					case '小' : $arr['list']['t'.(4+$tempnum).'_12']=$arr['list']['t'.(4+$tempnum).'_12'] - $n; break;
					case '單' : $arr['list']['t'.(4+$tempnum).'_13']=$arr['list']['t'.(4+$tempnum).'_13'] - $n; break;
					case '雙' : $arr['list']['t'.(4+$tempnum).'_14']=$arr['list']['t'.(4+$tempnum).'_14'] - $n; break;
					
					case '龍' : $arr['list']['t'.(4+$tempnum).'_15']=$arr['list']['t'.(4+$tempnum).'_15'] - $n; break;
					
					case '虎' : $arr['list']['t'.(4+$tempnum).'_16']=$arr['list']['t'.(4+$tempnum).'_16'] - $n; break;
				}
			...
			if($RepList[$i]['g_mingxi_1'] == $typeString[0] ){
				switch ($RepList[$i]['g_mingxi_2']) {
					...
					case '8' : 
						...
						break;
					case '9' : 
						if ($list['list']['t'.(1+$tempnum).'_9'] >0)
							$list['list_s']['t'.(1+$tempnum).'_9'] = $list['count'][0] + $list['count'][8] - $list['list']['t'.(1+$tempnum).'_9'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(1+$tempnum).'_9'] = $list['count'][8];
						break;
					case '10' : 
						if ($list['list']['t'.(1+$tempnum).'_10'] >0)
							$list['list_s']['t'.(1+$tempnum).'_10'] = $list['count'][0] + $list['count'][8] - $list['list']['t'.(1+$tempnum).'_10'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(1+$tempnum).'_10'] = $list['count'][8];
							break;
					
					case '大' : 
						if ($list['list']['t'.(1+$tempnum).'_11'] >0)
							$list['list_s']['t'.(1+$tempnum).'_11'] = $list['list']['t'.(1+$tempnum).'_11'] + $list['count'][9] - $list['list']['t'.(1+$tempnum).'_11'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(1+$tempnum).'_11'] = $list['count'][9];
						break;
					case '小' : 
						if ($list['list']['t'.(1+$tempnum).'_12'] >0)
							$list['list_s']['t'.(1+$tempnum).'_12'] = $list['list']['t'.(1+$tempnum).'_12'] + $list['count'][9] - $list['list']['t'.(1+$tempnum).'_12'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(1+$tempnum).'_12'] = $list['count'][9];
						break;
					case '單' : 
						if ($list['list']['t'.(1+$tempnum).'_13'] >0){
							$list['list_s']['t'.(1+$tempnum).'_13'] = $list['list']['t'.(1+$tempnum).'_13'] + $list['count'][10] - $list['list']['t'.(1+$tempnum).'_13'] * $RepList[$i]['g_odds']; 
						}
						else 
							$list['list_s']['t'.(1+$tempnum).'_13'] = $list['count'][10];
						break;
					case '雙' : 
						if ($list['list']['t'.(1+$tempnum).'_14'] >0)
							$list['list_s']['t'.(1+$tempnum).'_14'] = $list['list']['t'.(1+$tempnum).'_14'] + $list['count'][10] - $list['list']['t'.(1+$tempnum).'_14'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(1+$tempnum).'_14'] = $list['count'][10];
						break;
					
					case '龍' : 
						if ($list['list']['t'.(1+$tempnum).'_15'] >0)
							$list['list_s']['t'.(1+$tempnum).'_15'] = $list['list']['t'.(1+$tempnum).'_15'] + $list['count'][18] - $list['list']['t'.(1+$tempnum).'_15'] * $RepList[$i]['g_odds'];
						else 
							$list['list_s']['t'.(1+$tempnum).'_15'] = $list['count'][18];
						 break;
					
					case '虎' : 
						if ($list['list']['t'.(1+$tempnum).'_16'] >0)
							$list['list_s']['t'.(1+$tempnum).'_16'] = $list['list']['t'.(1+$tempnum).'_16'] + $list['count'][18] - $list['list']['t'.(1+$tempnum).'_16'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(1+$tempnum).'_16'] = $list['count'][18];
						break;
				} 
				}else if($RepList[$i]['g_mingxi_1'] == $typeString[1] ){
				switch ($RepList[$i]['g_mingxi_2']) {
					...
					case '7' : 
						...
						break;
					case '8' : 
						if ($list['list']['t'.(2+$tempnum).'_8'] >0)
							$list['list_s']['t'.(2+$tempnum).'_8'] = $list['count'][0] + $list['count'][8] - $list['list']['t'.(2+$tempnum).'_8'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(2+$tempnum).'_8'] = $list['count'][8];
						break;
					case '9' : 
						if ($list['list']['t'.(2+$tempnum).'_9'] >0)
							$list['list_s']['t'.(2+$tempnum).'_9'] = $list['count'][0] + $list['count'][8] - $list['list']['t'.(2+$tempnum).'_9'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(2+$tempnum).'_9'] = $list['count'][8];
						break;
					case '10' : 
						if ($list['list']['t'.(2+$tempnum).'_10'] >0)
							$list['list_s']['t'.(2+$tempnum).'_10'] = $list['count'][0] + $list['count'][8] - $list['list']['t'.(2+$tempnum).'_10'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(2+$tempnum).'_10'] = $list['count'][8];
							break;
					
					case '大' : 
						if ($list['list']['t'.(2+$tempnum).'_11'] >0)
							$list['list_s']['t'.(2+$tempnum).'_11'] = $list['list']['t'.(2+$tempnum).'_11'] + $list['count'][9] - $list['list']['t'.(2+$tempnum).'_11'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(2+$tempnum).'_11'] = $list['count'][9];
						break;
					case '小' : 
						if ($list['list']['t'.(2+$tempnum).'_12'] >0)
							$list['list_s']['t'.(2+$tempnum).'_12'] = $list['list']['t'.(2+$tempnum).'_12'] + $list['count'][9] - $list['list']['t'.(2+$tempnum).'_12'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(2+$tempnum).'_12'] = $list['count'][9];
						break;
					case '單' : 
						if ($list['list']['t'.(2+$tempnum).'_13'] >0){
							$list['list_s']['t'.(2+$tempnum).'_13'] = $list['list']['t'.(2+$tempnum).'_13'] + $list['count'][10] - $list['list']['t'.(2+$tempnum).'_13'] * $RepList[$i]['g_odds']; 
						}
						else 
							$list['list_s']['t'.(2+$tempnum).'_13'] = $list['count'][10];
						break;
					case '雙' : 
						if ($list['list']['t'.(2+$tempnum).'_14'] >0)
							$list['list_s']['t'.(2+$tempnum).'_14'] = $list['list']['t'.(2+$tempnum).'_14'] + $list['count'][10] - $list['list']['t'.(2+$tempnum).'_14'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(2+$tempnum).'_14'] = $list['count'][10];
						break;
					
					case '龍' : 
						if ($list['list']['t'.(2+$tempnum).'_15'] >0)
							$list['list_s']['t'.(2+$tempnum).'_15'] = $list['list']['t'.(2+$tempnum).'_15'] + $list['count'][18] - $list['list']['t'.(2+$tempnum).'_15'] * $RepList[$i]['g_odds'];
						else 
							$list['list_s']['t'.(2+$tempnum).'_15'] = $list['count'][18];
						 break;
					
					case '虎' : 
						if ($list['list']['t'.(2+$tempnum).'_16'] >0)
							$list['list_s']['t'.(2+$tempnum).'_16'] = $list['list']['t'.(2+$tempnum).'_16'] + $list['count'][18] - $list['list']['t'.(2+$tempnum).'_16'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(2+$tempnum).'_16'] = $list['count'][18];
						break;
				} 
				}else if($RepList[$i]['g_mingxi_1'] == $typeString[2] ){
				switch ($RepList[$i]['g_mingxi_2']) {
					...
					case '龍' : 
						if ($list['list']['t'.(3+$tempnum).'_15'] >0)
							$list['list_s']['t'.(3+$tempnum).'_15'] = $list['list']['t'.(3+$tempnum).'_15'] + $list['count'][18] - $list['list']['t'.(3+$tempnum).'_15'] * $RepList[$i]['g_odds'];
						else 
							$list['list_s']['t'.(3+$tempnum).'_15'] = $list['count'][18];
						 break;
					
					case '虎' : 
						if ($list['list']['t'.(3+$tempnum).'_16'] >0)
							$list['list_s']['t'.(3+$tempnum).'_16'] = $list['list']['t'.(3+$tempnum).'_16'] + $list['count'][18] - $list['list']['t'.(3+$tempnum).'_16'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(3+$tempnum).'_16'] = $list['count'][18];
						break;
				} 
				}else if($RepList[$i]['g_mingxi_1'] == $typeString[3] ){
				switch ($RepList[$i]['g_mingxi_2']) {
					...
					case '虎' : 
						if ($list['list']['t'.(4+$tempnum).'_16'] >0)
							$list['list_s']['t'.(4+$tempnum).'_16'] = $list['list']['t'.(4+$tempnum).'_16'] + $list['count'][18] - $list['list']['t'.(4+$tempnum).'_16'] * $RepList[$i]['g_odds']; 
						else 
							$list['list_s']['t'.(4+$tempnum).'_16'] = $list['count'][18];
						break;
				} 
				}
...
/**
	...
	{
		$result = $this->db->query("SELECT * FROM g_kaipan4 WHERE `g_lock` = 2 ORDER BY g_qishu DESC LIMIT 1  ", 1);
		if ($result)
		{
			switch ($this->cid)
			{
				case '1': $p=17; $g_id = "Ball_11";
						  $oddsList1 = selectOddspk($p, $g_id, 4); //賠率
						  $g_id = "Ball_12";
						  $oddsList2 = selectOddspk($p, $g_id, 4); //賠率
						  $g_id = "Ball_1";
						  $oddsList3 = selectOddspk($p, $g_id, 4); //賠率
						  $g_id = "Ball_2";
						  $oddsList4 = selectOddspk($p, $g_id, 4); //賠率
						  $oddsList = array_merge($oddsList1,$oddsList2,$oddsList3,$oddsList4);
				 break;
				case '2': 
						  $p=17; $g_id = "Ball_3";
						  $oddsList1 = selectOddspk($p, $g_id, 4); //賠率
			...
			//$oddsList = selectOddspk($p, $g_id, 4); //賠率
	...
	public function SumResult($Users)
	{
		...
		{
			$result = $this->db->query("SELECT `g_nid`,`g_login_id`, `g_name` FROM `j_manage` WHERE g_nid = '{$Users[0]['g_nid']}' LIMIT 1", 1);
	...
	public function PostCrystls($List, $param='a')
	{
		...
		switch ($this->User[0]['g_login_id'])
		{
			case 56 :
				...
				{
					$floorMoneypk = floorMoneypk ($this->User, $p, $List['s_num'][$i], $RankUser, $s);
					...
					$arr[$i]['g_tueishui'] = $floorMoneypk;
					$arr[$i]['g_tueishui_1'] = 0;
					$arr[$i]['g_tueishui_2'] = 0;
					$arr[$i]['g_tueishui_3'] = 0;
					$arr[$i]['g_tueishui_4'] = $floorMoneypk;
			...
			case 22 :
				...
				for ($i=0; $i<count($List['s_num']); $i++)
				{
					...
					$arr[$i]['g_tueishui_1'] = 0;
					$arr[$i]['g_tueishui_2'] = 0;
					$arr[$i]['g_tueishui_3'] = $floorMoneypk;
					$arr[$i]['g_tueishui_4'] = $floorMoneypk;
					$arr[$i]['g_distribution'] = 0;
					$arr[$i]['g_distribution_1'] = 0;
					$arr[$i]['g_distribution_2'] = 0;
			...
			case 78 :
				...
				for ($i=0; $i<count($List['s_num']); $i++)
				{
					$floorMoneypk1 = floorMoneypk ($this->User, $p, $List['s_num'][$i], $RankUser1, $s);
					$floorMoneypk2 = floorMoneypk ($this->User, $p, $List['s_num'][$i], $RankUser2, $s);
					$arr[$i]['g_t_id'] = $List['s_id'];
					$arr[$i]['g_s_nid'] = $this->User[0]['g_nid'];
					$arr[$i]['g_nid'] = '總代理走飛';
					$arr[$i]['g_mumber_type'] = 5;
					...
					$arr[$i]['g_odds'] = $List['s_odds'];
					$arr[$i]['g_jiner'] = $List['s_money'][$i];
					$arr[$i]['g_tueishui'] = $floorMoneypk1;
					$arr[$i]['g_tueishui_1'] = 0;
					$arr[$i]['g_tueishui_2'] = $floorMoneypk1;
					$arr[$i]['g_tueishui_3'] = $floorMoneypk2;
					$arr[$i]['g_tueishui_4'] = $floorMoneypk2;
					$arr[$i]['g_distribution'] = 0;
					$arr[$i]['g_distribution_1'] = 0;
			...
			case 48 :
				...
				for ($i=0; $i<count($List['s_num']); $i++)
				{
					$floorMoneypk1 = floorMoneypk ($this->User, $p, $List['s_num'][$i], $RankUser1, $s);
					$floorMoneypk2 = floorMoneypk ($this->User, $p, $List['s_num'][$i], $RankUser2, $s);
					$floorMoneypk3 = floorMoneypk ($this->User, $p, $List['s_num'][$i], $RankUser3, $s);
					$arr[$i]['g_t_id'] = $List['s_id'];
					$arr[$i]['g_s_nid'] = $this->User[0]['g_nid'];
					$arr[$i]['g_nid'] = '代理走飛';
					$arr[$i]['g_mumber_type'] = 5;
					...
					$arr[$i]['g_jiner'] = $List['s_money'][$i];
					$arr[$i]['g_tueishui'] = $floorMoneypk1;
					$arr[$i]['g_tueishui_1'] = $floorMoneypk1;
					$arr[$i]['g_tueishui_2'] = $floorMoneypk2;
					$arr[$i]['g_tueishui_3'] = $floorMoneypk3;
					$arr[$i]['g_tueishui_4'] = $floorMoneypk3;
					$arr[$i]['g_distribution'] = 0;
