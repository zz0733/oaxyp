...
$ccd=isBallTypecqsz($s_cq[0][0],$s_cq[0][1]);
...
$gMoney = $max['KeYongEr'];
$s = isBallTypecqsz($s_cq[0][0], $s_cq[0][1]);
?>
...
<form id="dp" action="inc/DataProcessingjxsscsz.php" method="post" onsubmit = "return submitformscq()">
