...
(function($) {
	...
	$.fn.poshytip.defaults = {
		...
		showTimeout:		10,		// timeout before showing the tip (in milliseconds 1000 == 1 second)
		hideTimeout:		10,		// timeout before hiding the tip
		...
		showAniDuration: 	10,//300,		// show animation duration - set to 0 if you don't want show animation
		hideAniDuration: 	10,//300,		// hide animation duration - set to 0 if you don't want hide animation
		refreshAniDuration:	10//200		// refresh animation duration - set to 0 if you don't want animation when updating the tooltip asynchronously
	};
