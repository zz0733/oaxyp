...
<script type="text/javascript" src="./js/odds_zh_xyft.js"></script>
    ...
    <tr>
        ...
        <td colspan="2"><form id="form1" name="form1" method="post" action="">
          <label><span style="color:#0033FF; font-weight:bold" id="tys">
			...
			window.parent.frames.mainFrame.location.href = "sGame_xyft.php?g=<?php echo$g?>&abc="+sel.value;
			}
...
<table border="0" width="700" style="margin-top:5px;top:10px;">
	<tr height="30">
    	<td align="center" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    	...
	    	<span id="Shortcut_DIV" class="font_g"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" onclick="Shortcut_hidden();reset();" class="inputs ti" value="重&nbsp;填" />&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" id="submits" class="inputs ti" value="下&nbsp;註" /><input type="text" id="submitss"  value="" style="width:0px;height:0px;border:0px;"/></span></td>
