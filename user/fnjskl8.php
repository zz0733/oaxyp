...
if (!isset($_GET['numberid'])||!isset($_GET['hid'])||!isset($_GET['tid'])) 
	exit(back('Error'));
...
<script type="text/javascript" src="./js/sGetkl8.js"></script>
<style type="text/css">
body {background-color:#FFEFE2}
</style>
</head>
<body>
<form id="dp" action="inc/DataProcessingkl8js.php" method="post" onsubmit = "return submitformscq()">
                    ...
                    <tr>
                    	<td class="t_td_text" colspan="2" align="center">
                        	...
                        	if($s[0] == '總和、龍虎和') {
                        		...
                        		echo $nn = '<span style="color:#0000FF">'.$s[1].'</span>@';
                        	}
                        	?>
