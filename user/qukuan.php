...
<table border="0" cellpadding="0" cellspacing="1" class="t_list" width="600">
        ...
        <tr style="height:28px">
			...
			<option value="工商银行" <?php echo$result[0]['g_yinhang']=='工商银行'? 'selected="selected"':'';?> >工商银行</option>
			<option value="中国银行"  <?php echo$result[0]['g_yinhang']=='中国银行'? 'selected="selected"':'';?> >中国银行</option>
			<option value="农业银行"  <?php echo$result[0]['g_yinhang']=='农业银行'? 'selected="selected"':'';?> >农业银行</option>
			<option value="建设银行"  <?php echo$result[0]['g_yinhang']=='建设银行'? 'selected="selected"':'';?> >建设银行</option>
		    ...
		    <option value="招商银行"  <?php echo$result[0]['g_yinhang']=='招商银行'? 'selected="selected"':'';?> >招商银行</option>
        	<option value="民生银行"  <?php echo$result[0]['g_yinhang']=='民生银行'? 'selected="selected"':'';?> >民生银行</option>
			<option value="深圳发展银行"  <?php echo$result[0]['g_yinhang']=='深圳发展银行'? 'selected="selected"':'';?> >深圳发展银行</option>
			<option value="中信银行"  <?php echo$result[0]['g_yinhang']=='中信银行'? 'selected="selected"':'';?> >中信银行</option>
		    <option value="浦发银行"  <?php echo$result[0]['g_yinhang']=='浦发银行'? 'selected="selected"':'';?> >浦发银行</option>
	        <option value="光大银行"  <?php echo$result[0]['g_yinhang']=='光大银行'? 'selected="selected"':'';?> >光大银行</option>
			<option value="广东发展银行"  <?php echo$result[0]['g_yinhang']=='广东发展银行'? 'selected="selected"':'';?> >广东发展银行</option>
		    <option value="华夏银行"  <?php echo$result[0]['g_yinhang']=='华夏银行'? 'selected="selected"':'';?> >华夏银行</option>
