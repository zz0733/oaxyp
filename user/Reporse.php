...
<table border="0" cellpadding="0" cellspacing="1" class="t_list t_result" width="700">
       ...
       for ($i=0; $i<count($result); $i++) {
        ...
        <tr class="t_td_text" align="center" onMouseOver="this.style.backgroundColor='#FFFFA2'" onMouseOut="this.style.backgroundColor=''">
        	...
        	<td align="right"><font color="red" style="font-weight:bold" ><?php echo is_Number($SumNum['Win'], 1)?></font>&nbsp;</td>
        </tr>
        <?php }}?>
        ...
        <tr class="Man_bottom">
            ...
            <table width='100%' height='22' border='0' cellspacing='0' cellpadding='0' class="page_box"><tr>
               <?php    if (count($result) <1) {?>
                            <td align="center" class="red" height="22" style="padding-right:5px; padding-bottom:2px;"><font color="#FF0000">當前沒有數據…… </font></td>  <?php }else{
						$p = $page->diy_page();	 ?>
            <td align='left'>&nbsp;共&nbsp;<?php echo $p[0];?>&nbsp;筆註單</td><td align='center'>共&nbsp;<?php echo $p[2];?>&nbsp;頁</td><td align='right'>&nbsp;<?php echo $p[4];?>『<?php echo $p[5];?>』<?php echo $p[6];?>&nbsp;</td></tr></table></td>
            <?php }?>
             </tr>
</table>
</body>
