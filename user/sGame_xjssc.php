...
include_once ROOT_PATH.'user/offGamexjssc.php';
include_once ROOT_PATH.'functioned/cheCookie.php';
if ($user[0]['g_look'] == 2) exit(href('repore.php'));
$ConfigModel = configModel("`g_xjssc_game_lock`, `g_mix_money`");
if ($ConfigModel['g_xjssc_game_lock'] !=1)exit(href('right.php'));
...
<script type="text/javascript" src="./js/sGame_xjssc.js"></script>
...
<table class="th" border="0" cellpadding="0" cellspacing="0">
	<tr>
    	<td width="105" height="20" class="bolds">新疆时时彩</td>
...
<table class="th" border="0" cellpadding="0" cellspacing="0" style="margin-top:-3px;">
    <tr>
        ...
        <td width="60"><form id="form1" name="form1" method="post" action="">
			...
			window.parent.frames.mainFrame.location.href = "sGame_xjssc.php?g=<?php echo $g?>&abc="+sel.value;
			}
...
<input type="hidden" name="gtypes" value="10" />
