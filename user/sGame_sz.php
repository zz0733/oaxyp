...
<script type="text/javascript" src="./js/odds_sz.js"></script>
...
<table class="thsz" border="0" cellpadding="0" cellspacing="0" style="margin-top:0px;">
    <tr>
        ...
        <td><form id="form1" name="form1" method="post" action="">
			...
			window.parent.frames.mainFrame.location.href = "sGame_sz.php?g=<?php echo $g?>&abc="+sel.value;
			}
...
<table class="wqsz" border="0" cellpadding="0" cellspacing="1">
	<tr class="t_list_caption">
	   ...
	   <td onfocus="this.className='nv_a'" onblur="this.className='nv'" class='nv'><a class="nv" <?php echo $onclick?>>第6球</a></td>
	   <td onfocus="this.className='nv_a'" onblur="this.className='nv'" class='nv'><a class="nv" <?php echo $onclick?>>第7球</a></td>
	   <td onfocus="this.className='nv_a'" onblur="this.className='nv'" class='nv'><a class="nv" <?php echo $onclick?>>第8球</a></td>
    </tr>
    <tr>
