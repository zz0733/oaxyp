...
//	dump($c);
	...
	//dump($result);
	$ccd=isSzType($s_cq[$i][0],$s_cq[$i][1]);
	//dump($ccd);
...
//	}
	$odds=setoddssz($a,$odds,$user,1,$s_cq[$i][0]);
	...
	$DtnArray = SumRankDistribution ($user, $s_cq[$i][2], null, $c, true,true);
//	dump($DtnArray);
