...
echo '<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="5%" class="balls" id="s_type" style="position:relative;top:1px">'.$types.'</td>
                                    ...
                                    <td width="15%" style="color:red;font-weight:bold"><div  id="row1" style="position: relative; ; FONT-FAMILY: Arial; height: 15px; color: red; font-size: 10pt;">今天輸贏：<span id="win">0</span></div></td>
									<td width="136" height="26" align="right" bgcolor="#FFFFFF">
    									<b><span style="color:#FF6633" id="q_number"></span>期開獎:</b>
    								</td>
    								<td width="225" height="26" bgcolor="#FFFFFF">
    									...
    									<span id="q_h" class="qiuqiu" style="float:left"></span>
    								</td>
									<td align="right" nowrap="nowrap">
									<select name="NoTable" class="font_R" style="position: relative; height: 22px; top: 1px; cursor: hand;" onchange="Switch_NoType(this.value)">
									<option value="1" style="color:red;font-weight:bold">按虧盈排列</option>
									<option value="2" style="color:red;font-weight:bold">按球號排列</option>
									</select>
									<select name="money_XZ" style="position: relative; height: 22px; top: 1px; cursor: hand;" onchange="LoadXml();">
									<option value="0">實占</option>
									<option value="1">虚註</option>
									</select>
									</td>
                                    <td align="right" width="180">更新：<span id="RefreshTime">加載中...</span>&nbsp;&nbsp;
