	...
	switch($t)
	{
		case 0:
			for($i=1;$i<=5;$i++)
			{
				...
				for($k=1;$k<=14;$k++)
					$tmp[]="h".$k."=".$pl;
				$sql="update g_odds2_default set ".join(",",$tmp)."  where g_type='Ball_{$i}'";
				$db->query($sql, 2);
			}
			break;	
		case 1:
...
<script type="text/javascript" src="js/oddsInfo3.js"></script>
<title></title>
</head>
<body>
        ...
        <tr>
          ...
          <td background="/Admin/temp/images/tab_05.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="155"><font style="font-weight:bold" color="#344B50">&nbsp;賠率設置 - 重庆賠率設置</font></td>
