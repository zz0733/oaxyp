...
echo '<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="85" class="ls">&nbsp;<span id="number"></span>&nbsp;期</td>
                                    <td width="110" class="balls" id="s_type" style="position:relative;top:1px">'.$types.'</td>
									<td width="120" class="balls" id="s_type1" style="position:relative;top:1px; display:none">'.$types.'</td>
                                    <td width="130" style="font-weight:bold"><span id="offTime">加載中...</span><span id="EndTime" style="position:relative;color:red;letter-spacing:1px;">加載中...</span></td>
                                    <td width="300" style="color:red;font-weight:bold"><div  id="row1" style="position: relative; ; FONT-FAMILY: Arial; height: 15px; color: red; font-size: 10pt;">今天輸贏：<span id="win">0</span></div></td>									
<td width="31%">
<table border="0" cellpadding="0" cellspacing="0">    																
									<td align="left" bgcolor="#FFFFFF">
    									<b><span style="color:#FF6633" id="q_number"></span>期賽果:</b>
    								</td>
    								<td align="left" bgcolor="#FFFFFF">
                                    ...
                                    <td width="180" align="right">更新：<span id="RefreshTime">加載中...</span>&nbsp;&nbsp;
