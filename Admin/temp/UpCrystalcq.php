                                ...
                                <tr align="right" style="height:30px">
                                	...
                                	<td align="left">&nbsp;
                                		<select name="s_numtype">
                                		    ...
                                		    <option <?php if($result[0]['g_mingxi_1']=='前三'){echo'selected="selected"';}?> value="前三">前三</option>
                                			<option <?php if($result[0]['g_mingxi_1']=='中三'){echo'selected="selected"';}?> value="中三">中三</option>
											<option <?php if($result[0]['g_mingxi_1']=='后三'){echo'selected="selected"';}?> value="后三">后三</option>
											
											<?php } else if ($result[0]['g_mingxi_1']=='總和、龍虎和') {?>
											<option <?php if($result[0]['g_mingxi_1']=='總和、龍虎和'){echo'selected="selected"';}?> value="總和、龍虎和">總和、龍虎和</option>
