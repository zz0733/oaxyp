...
if ($ConfigModel['g_nowrecord_lock'] !=1 || $ConfigModel['g_nc_game_lock'] !=1 ||$ConfigModel['g_game_10'] !=1)
	exit(href('right.php'));
$oddsLock = false;
                    ...
                    <tr>
                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="t_odds" width="100%">
                                ...
                                <tr align="center">
                                	<td class="ball_2">蔬菜单选</td>
                                    <td class="ball_2">动物单选</td>
                                    <td class="ball_2">幸运二</td>
                                    <td class="ball_2">连连中</td>
                                    <td class="ball_2">背靠背</td>
                                    <td class="ball_2">幸运三</td>
                                    <td class="ball_2">幸运四</td>
                                    <td class="ball_2">幸运五</td>
                                </tr>
                                <tr align="center">
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                	<td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('蔬菜单选')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a101">-</a></td>
                                    <td class="odds">-</td>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('幸运二')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a102">-</a></td>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('连连中')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a103">-</a></td>
                                    <td class="odds">-</td>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('幸运三')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a104">-</a></td>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('幸运四')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a105">-</a></td>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('幸运五')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a106">-</a></td>
                                </tr>
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                ...
                                <tr align="center">
                                	<td class="ball_2"><input type="radio" name="ros" value="蔬菜单选" id="101" onclick="GoPinn(this)" /></td>
                                    <td class="ball_2"><input type="radio" name="ros" disabled="disabled" /></td>
                                    <td class="ball_2"><input type="radio" name="ros" value="幸运二" id="102" onclick="GoPinn(this)" /></td>
                                    <td class="ball_2"><input type="radio" name="ros" value="连连中" id="103" onclick="GoPinn(this)" /></td>
                                    <td class="ball_2"><input type="radio" name="ros" disabled="disabled" /></td>
                                    <td class="ball_2"><input type="radio" name="ros" value="幸运三" id="104" onclick="GoPinn(this)" /></td>
                                    <td class="ball_2"><input type="radio" name="ros" value="幸运四" id="105" onclick="GoPinn(this)" /></td>
                                    <td class="ball_2"><input type="radio" name="ros" value="幸运五" id="106" onclick="GoPinn(this)" /></td>
                                </tr>
                            </table>
