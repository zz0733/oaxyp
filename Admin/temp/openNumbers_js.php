...
if (isset($_GET['delid']) && Matchs::isNumber($_GET['delid']))
{
	...
	if ($id)
	{
		...
		exit(alert_href('刪除成功', 'openNumbers_js.php'));
	}
	else 
	{
...
if (isset($_GET['inserid']) && Matchs::isNumber($_GET['inserid']))
{
	...
	insertNumberjs('08:24:30', $inserid, 9, 1, 87, $ConfigModel['g_close_time']);
	exit(alert_href('操作成功', 'NumberInclude.php'));
}
else 
{
  ...
  <tr>
    ...
    <td class="c"><table border="0" cellspacing="0" class="main">
        <tr>
          ...
          <td background="/Admin/temp/images/tab_05.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td><font style="font-weight:bold" color="#344B50">&nbsp;開盤設置--吉林快3</font></td>
          ...
          <td class="c"><!-- strat -->
            ...
            <table border="0" cellspacing="0" class="conter">
              ...
              <tr>
                ...
                <td id="showTxt" class="left_p6" style="color:#0000FF;">最多新增一天82期數，系統將自動讀取開盤時間。</td>
              </tr>
              <tr>
                <td height="36" class="bj">總期數</td>
                <td class="left_p6"><input name="number" type="text" id="number" style="width:50px;" onfocus="this.className='inp1m'" onblur="this.className='inp1'" class="inp1" value="82" /></td>
              </tr>
              <tr>
                <td height="36" class="bj">封盤時間</td>
                <td class="left_p6"><input name="stratTime" type="text" id="stratTime" style="width:110px;" onfocus="this.className='inp1m'" onblur="this.className='inp1'" class="inp1" value="09-19 08:38:30" /></td>
              </tr>
              <tr>
                <td height="36" class="bj">開獎時間</td>
                <td class="left_p6"><input name="endTime" type="text" id="endTime" style="width:110px;" onfocus="this.className='inp1m'" onblur="this.className='inp1'" class="inp1" value="09-19 08:40:00" /></td>
              </tr>
        ...
        <tr>
          ...
          <td class="f" align="center"><span class="odds">（注意：系統會自動加載1-82期盤口）</span> 天:
