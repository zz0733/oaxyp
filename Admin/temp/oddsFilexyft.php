...
include_once ROOT_PATH.'Admin/temp/offGamexyft.php';
include_once ROOT_PATH.'Admin/ExistUser.php';
include_once ROOT_PATH.'Admin/config/AdminConfig.php';
if ($ConfigModel['g_nowrecord_lock'] !=1 || $ConfigModel['g_xyft_game_lock'] !=1)exit(href('right.php'));
$oddsLock = false;
...
switch ($g) {
	case '1':
		$types = '冠、亞軍 組合';
		if ($ConfigModel['g_game_xyft_1'] !=1)exit(href('right.php'));
		if (isset($_SESSION['Mean1']))
			$Mean = $_SESSION['Mean1'];
		break;
	case '2':
		$types = '三、四、伍、六名';
		if ($ConfigModel['g_game_xyft_2'] !=1)exit(href('right.php'));
		if (isset($_SESSION['Mean2']))
			$Mean = $_SESSION['Mean2'];
		break;
	case '3':
		$types = '七、八、九、十名';
		if ($ConfigModel['g_game_xyft_3'] !=1)exit(href('right.php'));
...
<script type="text/javascript" src="/Admin/temp/js/oddsFilexyft.js"></script>
<script type="text/javascript" src="/Admin/temp/js/setOddspk.js"></script>
<script type="text/javascript">
<!--
	function setMean($this){
		var patrn=/^[0-9-]{1,9}$/; 
		if (patrn.exec($this.value)){
			$.post("/Admin/temp/ajaxad/jsonnc.php", {typeid : 4, meanid : $this.value, cid : <?php echo $g?>}, function(){});
		}
	}
            	...
            	<table border="0" cellspacing="0" class="main">
                	<tr>
                        ...
                        <td background="/Admin/temp/images/tab_05.gif">
                        	<?php include_once ROOT_PATH.'Admin/temp/oddsTopxyft.php';?>
                        </td>
                    ...
                    <tr>
                        ...
                        <!-- strat -->
						<?php if($g==1){?>
                            <table border="0" cellspacing="0" class="t_odds" width="19%" style="margin:0px -5px;margin-top:5px;top:1px;">
                            	<tr class="tr_top">
                                	<td width="15%">號</td>
                                    <td width="30%">賠率</td>
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>冠、亞軍和 指定</b></td><?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>冠、亞軍和 指定</b></td><?php }?>
								</tr>
                            ...
                            <table border="0" cellspacing="0" class="t_odds" width="19%" style="margin-left:8px;margin-top:5px;top:1px;">
                            	<tr class="tr_top">
                                	<td width="15%">項</td>
                                    <td width="30%">賠率</td>
                                    <?php if ($oddsLock){?><td width="10%" colspan="2">設置</td><?php }?>
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>冠、亞軍和 兩面</b></td><?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>冠、亞軍和 兩面</b></td><?php }?>
								</tr>
                                <tr align="center" class="odds11">
							...
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin-left:3px;margin-top:5px;top:1px;">
                            	<tr class="tr_top">
                                	<td width="15%">號</td>
                                    <td width="30%">賠率</td>
                                    <?php if ($oddsLock){?><td width="10%" colspan="2">設置</td><?php }?>
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>冠軍</b></td><?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>冠軍</b></td><?php }?>
								</tr>
                                <tr align="center" class="odds11">
								...
								<tr>
								<?php if ($oddsLock){?>
                                <td colspan="6" class="hbvalai"> <div>總額：<span class="ls" id="CountNum">0</span></div></td>
								<?php }else{ ?>
								<td colspan="4" class="hbvalai"> <div>總額：<span class="ls" id="CountNum">0</span></div></td>
								<?php }?>
								</tr>								
							</table>								
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin-left:3px;margin-top:5px;top:1px;">
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>亞軍</b></td><?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>亞軍</b></td><?php }?>
								</tr>
                                <tr align="center" class="odds11">
							...
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin:0px -5px;margin-top:5px;top:1px;">
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>第三名</b></td><?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>第三名</b></td><?php }?>
								</tr>
                                <tr align="center" class="odds11">
							...
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin-left:8px;margin-top:5px;top:1px;">
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>第四名</b></td><?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>第四名</b></td><?php }?>
								</tr>
                                <tr align="center" class="odds11">
							...
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin-left:3px;margin-top:5px;top:1px;">
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>第五名</b></td><?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>第五名</b></td><?php }?>
								</tr>
                                <tr align="center" class="odds11">
							...
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin-left:3px;margin-top:5px;top:1px;">
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>第六名</b></td><?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>第六名</b></td><?php }?>
								</tr>
                                <tr align="center" class="odds11">
							...
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin:0px -5px;margin-top:5px;top:1px;">
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>第七名</b></td><?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>第七名</b></td><?php }?>
								</tr>
                                <tr align="center" class="odds11">
							...
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin-left:8px;margin-top:5px;top:1px;">
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>第八名</b></td>
								<?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>第八名</b></td>
								<?php }?>
								</tr>
                                <tr align="center" class="odds11">
							...
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin-left:3px;margin-top:5px;top:1px;">
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>第九名</b></td>
								<?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>第九名</b></td>
								<?php }?>
								</tr>
                                <tr align="center" class="odds11">
							...
							<table border="0" cellspacing="0" class="t_odds" width="19%" style="margin-left:3px;margin-top:5px;top:1px;">
								...
								<tr class="tr_top">
								<?php if ($oddsLock){?>
								<td  colspan="6"  class="tr_top"><b>第十名</b></td>
								<?php }else{ ?>
								<td  colspan="4"  class="tr_top"><b>第十名</b></td><?php }?>
								</tr>
                                <tr align="center" class="odds11">
                            ...
                            <table border="0" cellspacing="0" class="t_odds" width="110" style="margin-left:3px;margin-top:5px;top:1px;">
                            	<tr class="tr_top">
                            ...
                            <table border="0" cellspacing="0" class="t_odds" width="120" id="cl" style="margin-left:3px;margin-top:5px;top:1px;">
                            	<!-- <tr class="tr_toppk2">
                    ...
                    <tr>
                        ...
                        <?php }?>&nbsp;&nbsp;
						 <input type="button" class="inputs" onclick="window.open('/Fill.htm','','');" value="補貨說明" style="top: 0px; color: #0000FF; position: relative;" />
                        </td>
