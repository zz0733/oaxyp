...
var Urls = "/Admin/temp/ajaxad/jsonnc.php";
var EstateTime = 90;
var EndTime = 90;
var StartTime = 90;
	...
	$.post (Urls, {typeid : 3}, function (data) {
		if (data.num != ""){
			...
			for (var key in data.num){
				row_1Html.push("<tr bgcolor=\"#fff\" height=\"20\"><td  class=\"uo\">"+key+"</td><td class=\"fe\">"+data.num[key]+" 期</td></tr>");
			}
			var cHtml = '<tr class="tr_top"><th colspan="2"><font color="#000000">兩面長龍</font></th></tr>';
