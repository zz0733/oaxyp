...
cPos("后台-子账号-修改".$result[0]['g_s_name']);
?>
...
<input type="hidden" name="sid" value="<?php echo $result[0]['g_password']?>" /> 
	<table width="99%" height="100%" border="0" cellspacing="0" class="a">
                    ...
                    <tr>
                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="conter">
                                ...
                                <tr style="height:28px">
                                    <td class="bj">名稱:</td>
                                    <td class="left_p5"><input style="width:139px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' type="text" name="s_f_Name" id="s_f_Name" value="<?php echo $result[0]['g_s_f_name']?>"  maxlength="20" /></td>
                                </tr>
                                <tr style="height:28px">
                                    <td class="bj">密碼:</td>
        ...
        <tr>
        	<td height="6"><img src="/Admin/images/main_59.gif" alt="" /></td>
            <td bgcolor="#4F4F4F"></td>
            <td height="6"><img src="/Admin/images/main_62.gif" alt="" /></td>
        </tr>
    </table>
    </form>
</body>
