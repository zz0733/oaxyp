...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	{
//		dump($sql);
		$SumAmount = new SumAmountjs($arr['s_number'], false, $arr['uid'], $sum);
...
else 
{
	...
	$ps = false;
	if (!$db->query("SELECT g_qishu FROM g_history7 WHERE g_qishu = '{$result[0]['g_qishu']}' LIMIT 1 ", 0)){
		if ($db->query("SELECT g_id FROM g_kaipan7 WHERE g_qishu = '{$result[0]['g_qishu']}' LIMIT 1", 0))
			$ps = true;
		else
            ...
            <td class="c">
            	<table border="0" cellspacing="0" class="main">
                	<tr>
                        ...
                        <td background="/Admin/temp/images/tab_05.gif"></td>
                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="conter">
                                ...
                                <tr align="right" style="height:30px">
                                	...
                                	<td align="left">&nbsp;
                                		<select name="s_numcontent">
                                			...
                                			<?php }else if($result[0]["g_mingxi_1"]=="三军"){?>
                                			...
                                			<?php }else if($result[0]["g_mingxi_1"]=="圍骰全骰"){?>
                                			<option <?php if($result[0]['g_mingxi_2']=="1"){echo'selected="selected"';}?> value="1">1</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="2"){echo'selected="selected"';}?> value="2">2</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="3"){echo'selected="selected"';}?> value="3">3</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="4"){echo'selected="selected"';}?> value="4">4</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="5"){echo'selected="selected"';}?> value="5">5</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="6"){echo'selected="selected"';}?> value="6">6</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="全骰"){echo'selected="selected"';}?> value="全骰">全骰</option>
                                			<?php }else if($result[0]["g_mingxi_1"]=="點數"){?>
                                			<option <?php if($result[0]['g_mingxi_2']=="4点"){echo'selected="selected"';}?> value="4点">4点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="5点"){echo'selected="selected"';}?> value="5点">5点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="6点"){echo'selected="selected"';}?> value="6点">6点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="7点"){echo'selected="selected"';}?> value="7点">7点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="8点"){echo'selected="selected"';}?> value="8点">8点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="9点"){echo'selected="selected"';}?> value="9点">9点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="10点"){echo'selected="selected"';}?> value="10点">10点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="11点"){echo'selected="selected"';}?> value="11点">11点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="12点"){echo'selected="selected"';}?> value="12点">12点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="13点"){echo'selected="selected"';}?> value="13点">13点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="14点"){echo'selected="selected"';}?> value="14点">14点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="15点"){echo'selected="selected"';}?> value="15点">15点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="16点"){echo'selected="selected"';}?> value="16点">16点</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="17点"){echo'selected="selected"';}?> value="17点">17点</option>
                                		
                                			<?php }else if($result[0]["g_mingxi_1"]=="長牌"){?>
                                			<option <?php if($result[0]['g_mingxi_2']=="1,2"){echo'selected="selected"';}?> value="1,2">1,2</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="1,3"){echo'selected="selected"';}?> value="1,3">1,3</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="1,4"){echo'selected="selected"';}?> value="1,4">1,4</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="1,5"){echo'selected="selected"';}?> value="1,5">1,5</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="1,6"){echo'selected="selected"';}?> value="1,6">1,6</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="2,3"){echo'selected="selected"';}?> value="2,3">2,3</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="2,4"){echo'selected="selected"';}?> value="2,4">2,4</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="2,5"){echo'selected="selected"';}?> value="2,5">2,5</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="2,6"){echo'selected="selected"';}?> value="2,6">2,6</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="3,4"){echo'selected="selected"';}?> value="3,4">3,4</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="3,5"){echo'selected="selected"';}?> value="3,5">3,5</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="3,6"){echo'selected="selected"';}?> value="3,6">3,6</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="4,5"){echo'selected="selected"';}?> value="4,5">4,5</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="4,6"){echo'selected="selected"';}?> value="4,6">4,6</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="5,6"){echo'selected="selected"';}?> value="5,6">5,6</option>
                                			<?php }else if($result[0]["g_mingxi_1"]=="短牌"){?>
                                			<option <?php if($result[0]['g_mingxi_2']=="1"){echo'selected="selected"';}?> value="1">1</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="2"){echo'selected="selected"';}?> value="2">2</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="3"){echo'selected="selected"';}?> value="3">3</option>
                                			<option <?php if($result[0]['g_mingxi_2']=="4"){echo'selected="selected"';}?> value="4">4</option>
                                ...
                                <tr align="right" style="height:30px">
                                	<td class="bj">賠率</td>
                                	<td align="left">&nbsp;
                                	<?php echo '<input type="text" class="textc" name="s_odds" value="'.$result[0]['g_odds'].'" />';?></td>
                                </tr>
                                <tr align="right" style="height:30px">
                                	<td class="bj">下注金額</td>
                                	<td align="left">&nbsp;
