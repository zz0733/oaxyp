                        ...
                        <!-- end -->
						  ...
						  <table border="0" cellspacing="0" class="conter">
								...
								$page = new Page($total, $pageNum);
 								$sql = "SELECT q.g_id,q.g_name,q.g_money,q.g_date,q.g_type,q.g_state,q.BankName,z.g_yinhang,z.g_zhanghao,z.g_xingming FROM `g_qdetail` q left join g_ziliao z on q.g_name=z.g_name  order by q.g_id desc {$page->limit}";
								...
								if($resultqd[$i]['g_type'] == 1)
								{
								echo $resultqd[$i]['g_yinhang'];
								}else{
								echo $resultqd[$i]['BankName'];
								}?></td>
