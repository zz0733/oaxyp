...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['actions']) && isset($_GET['cid']))
{
	//新增帳號
	if ($_GET['actions'] == 'add')
	{
...
function getSelect ($Rank, $userModel)
{
	...
	if($Rank[0]=="总公司")
	$Rank[0]="分公司";
	$option1 = '<tr><td class="bj">上級'.$Rank[0].'</td><td class="left_p5" style="color:#0000FF"><select name="s" id="s" onchange="FirstRankMoney()">';
                        ...
                        <td background="/Admin/temp/images/tab_05.gif">
                        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
	                                ...
	                                <td width="99%"><font style="font-weight:bold" color="#344B50">&nbsp;<?php echo $Rank[1]=="总公司"? "分公司":$Rank[1];?>&nbsp;->新增</font></td>									
                                  </tr>
                            </table>
                        </td>
                        ...
                        <?php if ($aid=='add'){?>
                        	<table border="0" cellspacing="0" class="conter">
                                ...
                                <tr style="height:28px">
                                    ...
                                    <td class="left_p5">
									<input name="s_Name" id="s_Name" type="text"  style="width:85px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' />
									&nbsp;&nbsp; 
                                    	【<input name="lock" type="radio" value="1"checked="checked" />啟用&nbsp;
                                    	<input name="lock" type="radio" value="2" />凍結&nbsp;
                                        <input name="lock" type="radio" value="3" />停用&nbsp;】
                                    </td>
                                </tr>
                                <tr style="height:28px">
                                	<td class="bj"><?php echo $Rank[1]=="总公司"? "分公司":$Rank[1];?>名稱</td>
                                    <td class="left_p5"><input  style="width:110px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' type="text" name="s_F_Name"  maxlength="20" /></td>
                                </tr>
                                <tr style="height:28px">
                                	<td class="bj">新密碼</td>
                                    <td class="left_p5"><input  style="width:110px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' type="password" name="s_Pwd" id="s_Pwd"  maxlength="20" /></td>
                                </tr>
                                <?php if ($cid != 1){?>
                                <tr style="height:28px">
                                	<td class="bj">信用額度</td>
                                    <td class="left_p5"><input  style="width:75px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' type="text" name="s_money" onKeyUp="To_RMB('s_money')" value="0"  maxlength="20" /><b id="rmb" class="red"></b></td>
                                </tr>
                                <?php if ($cid != 2){?>
                                <tr style="height:28px">
                                	<td class="bj"><?php echo $Rank[0]?>占成</td>
                                    <td class="left_p5"><input  style="width:35px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' type="text" name="s_size_ky" value="0"  maxlength="3" />%&nbsp; 
                                ...
                                <tr style="height:28px">
                                    ...
                                    <td class="left_p5"> <input style="width:35px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM'  type="text" name="s_next_KY" value="0"  maxlength="3" />&nbsp;%
							         ...
							         <font id="Size_KY"></font>
									   ...
									   <?php } else {?>
									    <tr style="height:28px">
                                	<td class="bj"><?php echo $Rank[1]?>占成</td>
                                    <td class="left_p5"><input type="radio" value="1" checked="checked" name="zy" id="zy"/>&nbsp;占余成数下线任占&nbsp;&nbsp; <input type="radio" value="0" name="zy" id="zy" />&nbsp;限制下线可占成数&nbsp;<input style="width:35px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM'  type="text" name="s_next_KY" value="0"  maxlength="3" />&nbsp;%								
									 </td>
									   <?php }?>
                                </tr>
                                <?php if ($cid != 2 && $cid != 3){?>
                                ...
                                <tr style="height:28px">
								 ...
								 <tr style="height:28px">
                                	<td class="bj">信用額度</td>
                                    <td class="left_p5"><input style="width:75px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' type="text" name="s_money" value="0"  maxlength="20" /></td>
                                </tr>
								  <tr style="height:28px">
								...
								<tr style="height:28px">
                                 ...
                                 <tr style="height:28px">
                                	<td class="bj">赚佣</td>
                                    <td class="left_p5"><input style="width:35px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM'  type="text"  name="g_zy" value="0"  maxlength="3" />&nbsp;</td>
                                </tr>
