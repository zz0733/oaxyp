...
include_once ROOT_PATH.'Admin/temp/offGamenc.php';
include_once ROOT_PATH.'Admin/ExistUser.php';
include_once ROOT_PATH.'Admin/config/config.php';
if ($ConfigModel['g_nowrecord_lock'] !=1 || $ConfigModel['g_nc_game_lock'] !=1 ||$ConfigModel['g_game_9'] !=1)
	exit(href('right.php'));
$oddsLock = false;
...
<script type="text/javascript" src="/Admin/temp/js/oddsFilenc.js"></script>
<script type="text/javascript" src="/Admin/temp/js/setOddsnc.js"></script>
                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="t_odds" width="88%">
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('總和大')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a1">-</a><span id="b1" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('總和小')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a3">-</a><span id="b3" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('總和單')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a2">-</a><span id="b2" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('總和雙')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a4">-</a><span id="b4" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('zwd')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a5">-</a><span id="b5" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('zwx')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a7">-</a><span id="b7" class="so"></span></td>
                                    <td class="odds"><a class="psp" onclick="GoPos(this,'1')" id="d7">-</a></td>
                                </tr>
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                	<td class="ball_1" id="n6">家禽</td>
                                    <td class="odds" id="h6"></td>
                                    <?php if ($oddsLock){?>
                                    <td>
                                    	<input title="上調賠率" type="button" onclick="setodds('h6','Ball_<?php echo$g?>',this);setodds('h6-h36','Ball_1',this)" class="aase aase_a" name="1" />&nbsp;
	                                    <input title="下調賠率" type="button" onclick="setodds('h6','Ball_<?php echo$g?>',this);setodds('h6-h36','Ball_1',this)" class="aase aase_b" name="0"  />
	                                </td>
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('家禽')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a6">-</a><span id="b6" class="so"></span></td>
                                    <td class="odds"><a class="psp" onclick="GoPos(this,'1')" id="d6">-</a></td>
                                </tr>
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                	<td class="ball_1" id="n8">野兽</td>
                                    <td class="odds" id="h8"></td>
                                    <?php if ($oddsLock){?>
                                    <td>
                                    	<input title="上調賠率" type="button" onclick="setodds('h8','Ball_<?php echo$g?>',this);setodds('h8-h37','Ball_1',this)" class="aase aase_a" name="1" />&nbsp;
	                                    <input title="下調賠率" type="button" onclick="setodds('h8','Ball_<?php echo$g?>',this);setodds('h8-h37','Ball_1',this)" class="aase aase_b" name="0"  />
	                                </td>
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNotnc.php?pid=<?php echo base64_encode('野兽')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a8">-</a><span id="b8" class="so"></span></td>
