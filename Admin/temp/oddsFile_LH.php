...
if ($ConfigModel['g_nowrecord_lock'] !=1 || $ConfigModel['g_kg_game_lock'] !=1 ||$ConfigModel['g_game_9'] !=1)
	exit(href('right.php'));
$oddsLock = false;
                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="t_odds" width="88%">
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNot.php?pid=<?php echo base64_encode('總和大')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a1">-</a><span id="b1" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNot.php?pid=<?php echo base64_encode('總和小')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a3">-</a><span id="b3" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNot.php?pid=<?php echo base64_encode('總和單')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a2">-</a><span id="b2" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNot.php?pid=<?php echo base64_encode('總和雙')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a4">-</a><span id="b4" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNot.php?pid=<?php echo base64_encode('zwd')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a5">-</a><span id="b5" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNot.php?pid=<?php echo base64_encode('zwx')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a7">-</a><span id="b7" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNot.php?pid=<?php echo base64_encode('龍')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a6">-</a><span id="b6" class="so"></span></td>
                                ...
                                <tr align="center" onmouseover="this.style.backgroundColor='#FFFFA2'" onmouseout="this.style.backgroundColor=''">
                                    ...
                                    <?php }?>
                                    <td class="odds"><a href="CrystalIsNot.php?pid=<?php echo base64_encode('虎')?>&tid=<?php echo base64_encode($types)?>" target="_blank" id="a8">-</a><span id="b8" class="so"></span></td>
