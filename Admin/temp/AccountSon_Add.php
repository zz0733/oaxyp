            ...
            <td class="c">
            	<table border="0" cellspacing="0" class="main">
                        ...
                        <td background="/Admin/temp/images/tab_05.gif">
                        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
	                                    ...
	                                    <td width="99%"><font style="font-weight:bold" color="#344B50">&nbsp;子帳號&nbsp;->新增</font></td>
                                  </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <!-- strat -->
                            <table border="0" cellspacing="0" class="conter">
                            	<tr class="tr_top">
                                	<th colspan="2">基礎資料</th>
                                </tr>
                                <tr style="height:28px">
                                    <td class="bj">子帳號:</td>
                                    <td class="left_p5"><input style="width:139px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' type="text" name="s_Name" id="s_Name"  maxlength="20" /></td>
                                </tr>
                                <tr style="height:28px">
                                    <td class="bj">登入密碼:</td>
                                    <td class="left_p5"><input style="width:139px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' type="password" name="s_pwd" id="s_pwd" maxlength="20" /></td>
                                </tr>								
                                <tr style="height:28px">
                                    <td class="bj">子帳號名稱:</td>
                                    <td class="left_p5"><input style="width:139px;" onfocus="this.className='inp1mMM'" onblur="this.className='inp1MM'" class='inp1MM' type="text" name="s_f_Name" id="s_f_Name"  maxlength="20" /></td>
                                </tr>
                                <tr style="height:28px">
                                    <td class="bj">狀態:</td>
                                    <td class="left_p5">
                                ...
                                內部管理 <input name="lock_1" onclick="setManages(this)" style="position:relative;top:3px" type="checkbox" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;
                                		...
                                		<?php if(!$lock_6){?>
                                    	下線帳號管理 <input name="lock_2" style="position:relative;top:3px" type="checkbox" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;
                                    	<?php }else if ($lock_6 && $Users[0]['g_lock_2']==1){?>
                                		下線帳號管理 <input name="lock_2" style="position:relative;top:3px" type="checkbox" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;
                                		<?php }?>
                                		<?php if($LoginId != 89 && $LoginId != 56 && !$lock_6){?>
                                    	手工補貨、自動補貨設置(及變更記錄) <input name="lock_3" style="position:relative;top:3px" type="checkbox" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;
                                    	...
                                    	<?php if(!$lock_6){?>
                                    	交收報表查詢 <input name="lock_5" style="position:relative;top:3px" type="checkbox" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;
                                    	<?php }else if ($lock_6 && $Users[0]['g_lock_5']==1){?>
                                		交收報表查詢 <input name="lock_5" style="position:relative;top:3px" type="checkbox" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;
                                		<?php }?>
                                    	
                                    	<!--<?php if(!$lock_6){?>
                                    	子帳號管理 <input name="lock_6" style="position:relative;top:3px" type="checkbox" value="1" />
                    ...
                    <tr>
                        ...
                        <td class="f" align="center"><input type="submit" class="inputs" value="確定" />&nbsp;&nbsp;
