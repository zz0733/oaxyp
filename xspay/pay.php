...
<div style="margin-top:10px;margin:10px 0 10px 0;"><span class="STYLE1"><strong>在线冲值</strong></span>&nbsp;&nbsp;&nbsp;<!--<a class="len" onclick="url('user/cha_huikuan.php?s_time=<?=date("Y-m-d",time()-1123200)?>&e_time=<?=date("Y-m-d",time())?>')" style="color:#00F;text-decoration: underline;">冲值记录查看</a>--></div>

<form id="form1" name="form1" action="send.php" method="post" onsubmit="return VerifyData();" target="_blank">
                  ...
                  <tr>
                    ...
                    <td align="left"><div style="padding-left:20px;">
                     <table width="100%" border="0" cellpadding="0" cellspacing="0" style="left:0; line-height:40px;">
                       <tr class="b_rig">
                         <td><input name="pd_FrpId" type="radio" value="abc" checked>&nbsp;<img src="images/bank/nongye.gif" /></td>
                         <td><input name="pd_FrpId" type="radio" value="icbc">&nbsp;<img src="images/bank/gongshang.gif" /></td>
                         <td><input name="pd_FrpId" type="radio" value="ccb">&nbsp;<img src="images/bank/jianshe.gif" /></td>
                         </tr>
                         <tr>
                         <td><input name="pd_FrpId" type="radio" value="comm"/>&nbsp;<img src="images/bank/jiaotong.gif" /></td>
                         <td><input name="pd_FrpId" type="radio" value="boc">&nbsp;<img src="images/bank/zhongguo.gif" /></td>
                         <td><input name="pd_FrpId" type="radio" value="cmb">&nbsp;<img src="images/bank/zhaohang.gif" /></td>
                         </tr>
                       <tr class="b_rig"> 
                        
                         <td><input name="pd_FrpId" type="radio" value="cmbc">&nbsp;<img src="images/bank/minsheng.gif" /></td>
                         <td><input name="pd_FrpId" type="radio" value="ceb">&nbsp;<img src="images/bank/guangda.gif" /></td>
                         <td><input name="pd_FrpId" type="radio" value="cib" >&nbsp;<img src="images/bank/xingye.gif" /></td>
                       </tr>
                       <tr class="b_rig">
                         <td><input name="pd_FrpId" type="radio" value="ecitic">&nbsp;<img src="images/bank/zhongxin.gif" /></td>
                         <td><input name="pd_FrpId" type="radio" value="pingan"/>&nbsp;<img src="images/bank/pingan.gif" /></td>
                         <td><input name="pd_FrpId" type="radio" value="hxb">&nbsp;<img src="images/bank/huaxia.gif" /></td>
                       </tr>
                       <tr class="b_rig"> 
                         
                         <td><input name="pd_FrpId" type="radio" value="spdb">&nbsp;<img src="images/bank/shangpufa.gif" /></td>
                         <td><input name="pd_FrpId" type="radio" value="gdb">&nbsp;<img src="images/bank/gdb.gif" /></td>
                        
						<td><input name="pd_FrpId" type="radio" value="post">&nbsp;<img src="images/bank/youzheng.gif" /></td>
                       </tr>
