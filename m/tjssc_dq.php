...
$gameid=$_SESSION['cpopen'] = 11;
$gamelm=$_SESSION['lm']='dq';
...
if ($ConfigModel['g_cq_game_lock'] !=1)exit(href('ClosedLottery.php'));
//获取当前盘口
